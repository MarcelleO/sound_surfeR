...
BTemp_beep1 <- makeBinTemplate("D:\\BACK-UP'\\documents'\\UT AUSTIN\\Spring 2022\\ANT388 (R-coding)\\sound_surfer\\data\\3beep1.wav", frq.lim = c(3, 6), t.lim = c(0, .7), name = "3beep1", amp.cutoff = (-25))

#template 2 for beep sound .
BTemp_beep2 <- makeBinTemplate("D:\\BACK-UP'\\documents'\\UT AUSTIN\\Spring 2022\\ANT388 (R-coding)\\sound_surfer\\data\\3beep2.wav", frq.lim = c(3, 6), t.lim = c(0, .7), name = "3beep2", amp.cutoff = (-25))

#template 1 for clap sound 
BTemp_clap1 <- makeBinTemplate("D:\\BACK-UP'\\documents'\\UT AUSTIN\\Spring 2022\\ANT388 (R-coding)\\sound_surfer\\data\\clap1.wav", frq.lim = c(0.1, 6), t.lim = c(0, .5), name = "clap1", amp.cutoff = (-25))

#template 2 for clap sound 
BTemp_clap2 <- makeBinTemplate("D:\\BACK-UP'\\documents'\\UT AUSTIN\\Spring 2022\\ANT388 (R-coding)\\sound_surfer\\data\\clap2.wav", frq.lim = c(0.1, 6), t.lim = c(0, .5), name = "clap2", amp.cutoff = (-25))

#template 1 for note sound 
BTemp_note1 <- makeBinTemplate("D:\\BACK-UP'\\documents'\\UT AUSTIN\\Spring 2022\\ANT388 (R-coding)\\sound_surfer\\data\\note1.wav", frq.lim = c(0.1, 6), t.lim = c(0, .5), name = "note1", amp.cutoff = (-25))

#template 2 for note sound 
BTemp_note2 <- makeBinTemplate("D:\\BACK-UP'\\documents'\\UT AUSTIN\\Spring 2022\\ANT388 (R-coding)\\sound_surfer\\data\\note2.wav", frq.lim = c(0.1, 6), t.lim = c(0, .5), name = "note2", amp.cutoff = (-25))
...
CTemp_beep1 <- makeCorTemplate("D:\\BACK-UP'\\documents'\\UT AUSTIN\\Spring 2022\\ANT388 (R-coding)\\sound_surfer\\data\\3beep2.wav", frq.lim = c(3, 6), t.lim = c(0, .7), name = "3beep1", amp.cutoff = (-25))

#template 2 for beep sound .
CTemp_beep2 <- makeCorTemplate("D:\\BACK-UP'\\documents'\\UT AUSTIN\\Spring 2022\\ANT388 (R-coding)\\sound_surfer\\data\\3beep2.wav", frq.lim = c(3, 6), t.lim = c(0, .7), name = "3beep2", amp.cutoff = (-25))

#template 1 for clap sound 
CTemp_clap1 <- makeCorTemplate("D:\\BACK-UP'\\documents'\\UT AUSTIN\\Spring 2022\\ANT388 (R-coding)\\sound_surfer\\data\\clap1.wav", frq.lim = c(0.1, 6), t.lim = c(0, .5), name = "clap1", amp.cutoff = (-25))

#template 2 for clap sound 
CTemp_clap2 <- makeCorTemplate("D:\\BACK-UP'\\documents'\\UT AUSTIN\\Spring 2022\\ANT388 (R-coding)\\sound_surfer\\data\\clap2.wav", frq.lim = c(0.1, 6), t.lim = c(0, .5), name = "clap2", amp.cutoff = (-25))

#template 1 for note sound 
CTemp_note1 <- makeCorTemplate("D:\\BACK-UP'\\documents'\\UT AUSTIN\\Spring 2022\\ANT388 (R-coding)\\sound_surfer\\data\\note1.wav", frq.lim = c(0.1, 6), t.lim = c(0, .5), name = "note1", amp.cutoff = (-25))

#template 2 for note sound 
CTemp_note2 <- makeCorTemplate("D:\\BACK-UP'\\documents'\\UT AUSTIN\\Spring 2022\\ANT388 (R-coding)\\sound_surfer\\data\\note2.wav", frq.lim = c(0.1, 6), t.lim = c(0, .5), name = "note2", amp.cutoff = (-25))
...
```{r}
bma("D:\\BACK-UP'\\documents'\\UT AUSTIN\\Spring 2022\\ANT388 (R-coding)\\sound_surfer\\data\\clap3.wav", tempbin)

cma("D:\\BACK-UP'\\documents'\\UT AUSTIN\\Spring 2022\\ANT388 (R-coding)\\sound_surfer\\data\\clap3.wav", tempcor)
